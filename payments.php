                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" name="student_id" required="">
                   ...
                   <?php
                    ...
                    $sql1 = mysqli_query($con,"SELECT id,first_name,last_name,nic FROM student WHERE stat='1' AND is_dropped='0' ORDER BY first_name ASC");
                    while ($row = mysqli_fetch_array($sql1)) {
                        ...
                        $nic = $row['nic'];
                      ?>
                            <option value='<?php echo $id; ?>'><?php echo $first_name." ".$last_name." [".$nic."]"; ?></option>
                      <?php
                    }
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" name="payment_type" required="">
                   <?php
                    ...
                    $sql1 = mysqli_query($con,"SELECT id,name,amount FROM payment_type WHERE stat='1' ORDER BY name ASC");
                    while ($row = mysqli_fetch_array($sql1)) {
                        $payment_id = $row['id'];
                      ...
                      ?>
                            <option value='<?php echo $payment_id; ?>'><?php echo $payment_name." [".$payment_amount."]"; ?></option>
                      <?php
                    }
